...
import com.doozzonsa.global.response.code.ErrorCode;
import com.doozzonsa.global.response.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DooZzonSaException.class)
    public ResponseEntity<ErrorResponse> handleMyException(DooZzonSaException e) {
    ...
    public ResponseEntity<ErrorResponse> handleNoResourceFoundException(NoResourceFoundException e) {
        String detail = String.format("%s %s", e.getHttpMethod(), e.getMessage());
        return buildErrorResponse(ErrorCode.NOT_FOUND, detail);
    }
